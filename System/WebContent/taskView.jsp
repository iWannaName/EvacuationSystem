                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="${pageContext.request.contextPath}/TaskAuditServlet" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="recipient-name" class="col-form-label">恐怖分子人数:</label>
                                                            <input type="text" class="form-control" id="recipient-name" name="attackerNum">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="message-text" class="col-form-label">审核意见（选填）:</label>
