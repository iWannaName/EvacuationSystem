                                                ...
                                                <div class="modal-body">
                                                    <form action="${pageContext.request.contextPath}/TaskAuditServlet" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="radio" name="ispassed"> 通过
                                                            </label>
                                                            <label class="radio-inline mr-3">
                                                            <input type="radio" name="ispassed"> 不通过
                                                            </label>
                                                    ...
                                                    <button type="button" class="btn btn-primary" onclick="window.location.href='${pageContext.request.contextPath}/TaskAuditServlet'">确定</button>
                                                </div>
                                                    </form>
                                                </div>
