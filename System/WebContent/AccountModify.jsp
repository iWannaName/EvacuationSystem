        ...
        <div class="content-body">
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">账户信息修改</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
            ...
            <div class="container-fluid">
             ...
             <div class="col-12">
                      <div class="card">
                            <div class="card-body"> 
                            <form class="form-valide" action="AccountModifyServlet" method="post">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">警号 </label> 
                                            <div class="col-lg-4">
                                                <input type="text" readonly="readonly" class="form-control" name="usernameM" value="${user.police_id}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email">姓名 
                                            </label>
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control" name="realnameM" value="${user.name}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-password">单位 
                                            </label>
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control" name="unitM" value="${user.unit}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-confirm-password">职务
                                            </label>
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control" name="positionM" value="${user.position}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-suggestions">身份证号码
                                            </label>
                                            <div class="col-lg-4">
                                               <input type="text" class="form-control" name="idM" value="${user.id}">
                                            </div>
                                        </div>
                                       <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">出生日期 </label> 
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control" name="birthdateM" value="${user.birthdate}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">入队时间 </label> 
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control" name="jointimeM" value="${user.jointime}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">手机号</label> 
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control" name="telM" value="${user.tel}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">邮箱</label> 
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control" name="emailM" value="${user.email}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
