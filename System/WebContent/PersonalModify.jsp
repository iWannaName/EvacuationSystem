        ...
        <div class="content-body">
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">个人信息修改</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
            ...
            <div class="container-fluid">
             ...
             <div class="col-lg-8 col-xl-9">
                      <div class="card">
                            <div class="card-body"> 
                            <form class="form-valide" action="PersonalModifyServlet?parm=<%=username%>" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="password" class="form-control" name="position" value="<%=position%>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
