        ...
        <div class="content-body">
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">个人主页</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="media align-items-center mb-4">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-muted mb-0">China</p>
                                    </div>
                                </div>
                                </div>
                                </div>
                            ...
                            <div class="card-body">
                             <form action="PersonalModify.jsp" method="post">
                                <a href="${pageContext.request.contextPath}/PersonalAreaServlet">个人信息</a>
                                
                                <ul class="card-profile__info">
                                <div class="form-group row">
                                    <li class="mb-1"><strong class="text-dark mr-4">警号&nbsp;&nbsp;</strong> <span><%=username%></span></li>
                                    </div>
                                    <div class="form-group row">
                                    <li><strong class="text-dark mr-4">密码&nbsp;&nbsp;</strong> <span><%=password%></span></li>
                                    </div>
                                    <div class="form-group row">
                                    <li><strong class="text-dark mr-4">姓名&nbsp;&nbsp;</strong> <span><%=realname%></span></li></div>
                                    <div class="form-group row">
                                    <li><strong class="text-dark mr-4">单位&nbsp;&nbsp;</strong> <span><%=unit%></span></li></div>
                                    <div class="form-group row">
                                    <li><strong class="text-dark mr-4">职务&nbsp;&nbsp;</strong> <span><%=position%></span></li></div>
                                    <div class="form-group row">
                                    <li><strong class="text-dark mr-4">身份证号</strong> <span><%=id%></span></li></div>
                                    <div class="form-group row">
                                    <li><strong class="text-dark mr-4">出生日期</strong> <span><%=birthdate%></span></li></div>
                                    <div class="form-group row">
                                    <li><strong class="text-dark mr-4">入队时间</strong> <span><%=jointime%></span></li></div>
                                    <div class="form-group row">
                                    <li><strong class="text-dark mr-4">手机号&nbsp;</strong> <span><%=tel%></span></li></div>
                                    <div class="form-group row">
                                    <li><strong class="text-dark mr-4">邮箱&nbsp;&nbsp;</strong> <span><%=email%></span></li></div>
                                </ul>
                                 <button class="btn btn-primary px-3 ml-4">修改信息</button>
                                 </form>
                                </div>
                            </div>
                        </div>  
