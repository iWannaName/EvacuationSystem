                            ...
                            <div class="card-body">
                             <form action="PersonalModify.jsp" method="post">
                                ...
                                <ul class="card-profile__info">
                                    ...
                                    <li><strong class="text-dark mr-4">姓名&nbsp;&nbsp;</strong> <span><%=realname%></span></li>
                                    <li><strong class="text-dark mr-4">单位&nbsp;&nbsp;</strong> <span><%=unit%></span></li>
                                    <li><strong class="text-dark mr-4">职务&nbsp;&nbsp;</strong> <span><%=position%></span></li>
                                    <li><strong class="text-dark mr-4">身份证号</strong> <span><%=id%></span></li>
                                    <li><strong class="text-dark mr-4">出生日期</strong> <span><%=birthdate%></span></li>
                                    <li><strong class="text-dark mr-4">入队时间</strong> <span><%=jointime%></span></li>
                                    <li><strong class="text-dark mr-4">手机号&nbsp;</strong> <span><%=tel%></span></li>
                                    <li><strong class="text-dark mr-4">邮箱&nbsp;&nbsp;</strong> <span><%=email%></span></li>
                                </ul>
