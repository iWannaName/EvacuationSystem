                            ...
                            <h4 class="card-title">查询演练事件</h4>
                                    ...
                                    <form action="Querier.jsp" method="GET">
                                        <div class="form-row align-items-center">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <input type="text" class="form-control mb-2" name="UserID" placeholder="录入人警号">
                                            </div>
                                            <div class="col-auto">
                                                <label class="sr-only">演练时间</label>
                                                <input type="text" class="form-control mb-2" name="DrillTime" placeholder="演练时间">
                                            </div>
                                            <div class="col-auto">
                                                <input type="submit" class="btn mb-2 btn-primary" value="查询">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                         <%
                                         System.out.println("记录数为："+ret.size());
											for(int i=0;i<ret.size();i++){
